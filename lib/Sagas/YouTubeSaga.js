...
var _YouTubeSchema = require('../Schemas/YouTubeSchema');

var _YouTubeSchema2 = _interopRequireDefault(_YouTubeSchema);
...
exports.default = function (api) {
  var _marked = /*#__PURE__*/_regenerator2.default.mark(worker),
      ...
      _marked3 = /*#__PURE__*/_regenerator2.default.mark(watchYouTube);
    ...
    return _regenerator2.default.wrap(function worker$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _effects.call)(api.searchYouTube, meta);
          ...
          case 2:
            ...
            payload = (0, _normalizr.normalize)(response.data.items, (0, _normalizr.arrayOf)(_YouTubeSchema2.default));
            ...
            _context.next = 8;
            return (0, _effects.put)(_Creators2.default.getYouTubeSuccess(payload));
          ...
          case 10:
            _context.next = 12;
            return (0, _effects.put)(_Creators2.default.getYouTubeFailure());
    ...
    return _regenerator2.default.wrap(function watcher$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, _effects.take)(_Types2.default.GET_YOUTUBE_REQUEST);
  ...
  function watchYouTube() {
    var action, meta;
    return _regenerator2.default.wrap(function watchYouTube$(_context3) {
      while (1) {
