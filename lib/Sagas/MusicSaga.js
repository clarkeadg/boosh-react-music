...
exports.default = function (api) {
  var _marked = /*#__PURE__*/_regenerator2.default.mark(attemptGetMusic),
      _marked2 = /*#__PURE__*/_regenerator2.default.mark(attemptGetArtists),
      _marked3 = /*#__PURE__*/_regenerator2.default.mark(watchGetMusicAttempt),
      _marked4 = /*#__PURE__*/_regenerator2.default.mark(watchGetMusicPreloaderAttempt),
      _marked5 = /*#__PURE__*/_regenerator2.default.mark(watchGetArtistsAttempt),
      _marked6 = /*#__PURE__*/_regenerator2.default.mark(watchGetArtistsPreloaderAttempt);
  ...
  function attemptGetArtists(meta) {
    var query, path, response, data, count, payload;
    return _regenerator2.default.wrap(function attemptGetArtists$(_context2) {
      while (1) {
  ...
  function watchGetMusicPreloaderAttempt() {
    ...
    return _regenerator2.default.wrap(function watchGetMusicPreloaderAttempt$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return (0, _effects.take)(_Types2.default.GET_MUSIC_REQUEST);

          case 2:
            _ref = _context4.sent;
            meta = _ref.meta;
            _context4.next = 6;
            return (0, _effects.call)(attemptGetMusic, meta);
  ...
  function watchGetArtistsAttempt() {
    ...
    return _regenerator2.default.wrap(function watchGetArtistsAttempt$(_context5) {
      while (1) {
  ...
  function watchGetArtistsPreloaderAttempt() {
    ...
    return _regenerator2.default.wrap(function watchGetArtistsPreloaderAttempt$(_context6) {
      while (1) {
  ...
  return {
    ...
    watchGetMusicPreloaderAttempt: watchGetMusicPreloaderAttempt,

    attemptGetArtists: attemptGetArtists,
    watchGetArtistsAttempt: watchGetArtistsAttempt,
    watchGetArtistsPreloaderAttempt: watchGetArtistsPreloaderAttempt
  };
};